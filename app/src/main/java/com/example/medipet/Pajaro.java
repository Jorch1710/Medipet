...
public class Pajaro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.drawerP);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_inicio) {
                    startActivity(new Intent(Pajaro.this, MainActivity.class));
                } else if (itemId == R.id.nav_citas) {
                    startActivity(new Intent(Pajaro.this, activity_sucursales.class));
                } else if (itemId == R.id.nav_usuario) {
                    startActivity(new Intent(Pajaro.this, MainActivityKJ.class));
